...
class MenuAdministrador(Frame):
    def __init__(self, master ,modelo):
        ...
        self.btnState = False
        self.options = ["Gestión de usuarios", "Evaluación", "Experimentación","Salir"]
        self.widgets()
    ...
    def widgets(self):
        ...
        tk.Button(self.navRoot, text=self.options[0], font="BahnschriftLight 15", bg="gray17", fg=self.color["orange"],
                activebackground="gray17", activeforeground="#ff4040", bd=0,command=self.abrirGestionU).place(x=25, y=80)

        tk.Button(self.navRoot, text=self.options[1], font="BahnschriftLight 15", bg="gray17", fg=self.color["orange"],
                  activebackground="gray17", activeforeground="#ff4040", bd=0, command = self.abrirVistaEvaluacion).place(x=25, y=120)

        tk.Button(self.navRoot, text=self.options[2], font="BahnschriftLight 15", bg="gray17", fg=self.color["orange"],
                  activebackground="gray17", activeforeground="#ff4040", bd=0,command=self.abrirVistaExperimentacion).place(x=25, y=160)

        tk.Button(self.navRoot, text=self.options[3], font="BahnschriftLight 15", bg="gray17", fg=self.color["orange"],
                  activebackground="gray17", activeforeground="#ff4040", bd=0, command=self.salir).place(x=25, y=200)
    ...
    def salir(self):
        self.controlador.VistaMenuA_VistaLogin()
        self.navRoot.place(x=-300, y=0)
    ...
    def abrirGestionU(self):
        self.controlador.VistaMenuA_VistaGestionU()
        self.navRoot.place(x=-300, y=0)
        self.brandLabel.config(bg="gray17", fg="#ff4040")
        self.homeLabel.config(bg=self.color["orange"])
        self.topFrame.config(bg=self.color["orange"])
    ...
    def abrirVistaEvaluacion(self):
        self.controlador.VistaMenuA_VistaEvaluacion()
        self.navRoot.place(x=-300, y=0)
        self.brandLabel.config(bg="gray17", fg="#ff4040")
        self.homeLabel.config(bg=self.color["orange"])
        self.topFrame.config(bg=self.color["orange"])
    ...
    def abrirVistaExperimentacion(self):
        self.controlador.vistaMenuA_vistaExperimentacion()
        self.navRoot.place(x=-300, y=0)
        self.brandLabel.config(bg="gray17", fg="#ff4040")
        self.homeLabel.config(bg=self.color["orange"])
        self.topFrame.config(bg=self.color["orange"])
